...
/obj/structure/prop/rocket_pod
	icon = 'icons/Marine/mainship_props64.dmi'
	icon_state = "rocket_pod"
	name = "rocket pod"
	desc = "A rocket pod weapon system capable of launching a single laser-guided rocket."
	density = TRUE
	bound_height = 64

/obj/structure/prop/banshee
	icon = 'icons/Marine/mainship_props.dmi'
	icon_state = "banshee"
