...
GLOBAL_LIST_INIT(department_radio_keys_imp, list(
	MODE_KEY_R_HAND = MODE_R_HAND,
	MODE_KEY_L_HAND = MODE_L_HAND,
	MODE_KEY_INTERCOM = MODE_INTERCOM,
	...
	RADIO_KEY_MEDICAL = RADIO_CHANNEL_MEDICAL_IMP,
	RADIO_KEY_ENGINEERING = RADIO_CHANNEL_ENGINEERING_IMP,
	RADIO_KEY_COMMAND = RADIO_CHANNEL_COMMAND_IMP,
	RADIO_KEY_THETA = RADIO_CHANNEL_THETA,
	RADIO_KEY_OMEGA = RADIO_CHANNEL_OMEGA,
	RADIO_KEY_GAMMA = RADIO_CHANNEL_GAMMA,
	RADIO_KEY_SIGMA = RADIO_CHANNEL_SIGMA,
))
