...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["preferred_squad_imp"], preferred_squad_imp)
	...
	preferred_squad_imp	= sanitize_inlist(preferred_squad_imp, SELECTABLE_SQUADS_IMP, initial(preferred_squad_imp))
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["preferred_squad_imp"], preferred_squad_imp)
